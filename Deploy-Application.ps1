...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close Gephi if required, verify there is enough disk space to complete the install, and persist the prompt
		Show-InstallationWelcome -CloseApps 'gephi' -CheckDiskSpace -PersistPrompt
		...
		Remove-File -Path "$envCommonDesktop\Gephi.lnk" -ContinueOnError $true
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close Gephi with a 60 second countdown before automatically closing
		Show-InstallationWelcome -CloseApps 'gephi' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$envProgramFilesX86\Gephi-0.9.1\unins000.exe" -Parameters "/SILENT" -WindowStyle "Hidden" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDwZtYC7b5daNSy
# 9Rf4CO70y5oZiVouvp3lnoL3HXwpAKCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIHx4
# FFkmB5atCKy3JMaytyoHWh/w2lV6qlS99f2xGEwcMA0GCSqGSIb3DQEBAQUABIIB
# AGoQW/bmABUiz4vWjva8k8JRr3xbq5BEHpIunCVUbMffYsrB2TarJODDt48rH2NF
# hqG5t1rrihSrp7lplY0GycyULSQhW0RSYd9gvuxu/uUvgYQG3Bu57Fq9Y3dEzN49
# C8dstazgVfxAH/6ED19rg7M0mUIIlCwgwqmZGZF+MIkFDNSHN8ALVKgRLiAAT/Fd
# swcTVWISccZ8HBJXh6p81iuBm2gahKSQHFSdJB8r1MMKkRXF4KZHfDNCI8nG8Nq9
# q8wZrDdTekf9GZZGSsd3Mf1ulayzuHnXwrkQT2xTtmh+S8drLoVWWCy5eAlOXIWv
# J/eQA/U6XvpxZFAydcD7xlGhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMjAyMjMzMjU4WjAjBgkqhkiG9w0BCQQxFgQU
# 24uUglrq4w9tPXoPk9eXgDOe5dQwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAKhZUkQPUyV2aIMhlKKWqD3sje5m5l3HOHArwWLyDbM+lfgDAXJ+OkTr
# F4IRYOMoIZpGXsHnY1sueLdaOoIvPqjXSK2dWY7mRk50EYjxkmDhJL+/aWZmUzhs
# TuDj1lcTSU4akpUUCJZIsmYGern41fAVY1lhGWWPf7yU+OG0i2degLObpwon+Kag
# hlqswaOMwFng06TA2BpfPyNz8/rFeNIT1GronW0hppDCNTyRMUw7S6Xh5YWWBWUc
# fZjj66oejLgTlo89EGeGw8QAxReHq/ocjdLmOgJftFSo9gxesz153WmfOMbyH/CV
# SZIYObv+w0iDuim/nKTEsC+3lLxjwjk=
